...
const HeaderMyIncidentReportComponent: React.FC = () => {
  return (
    <div className="flex flex-col gap-2 mb-4">
      ...
      <div className="flex items-center gap-1">
        ...
        <h2 className="text-sm capitalize text-black">my incident report</h2>
      </div>
    </div>
  );
};

export default HeaderMyIncidentReportComponent;
