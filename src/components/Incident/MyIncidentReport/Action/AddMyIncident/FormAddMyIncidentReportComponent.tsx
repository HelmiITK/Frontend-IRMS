...
interface FormAddMyIncidentReportComponentProps {
...
const FormAddMyIncidentReportComponent: React.FC<
  FormAddMyIncidentReportComponentProps
  ...
  return (
    <div className="flex flex-col justify-center items-center ">
      <h2 className="text-xl font-semibold mb-4 flex items-center gap-2 w-full bg-gray-200  justify-center py-2">
        ...
        <span>Add My Incident Report</span>
      </h2>
      <form
...
export default FormAddMyIncidentReportComponent;
