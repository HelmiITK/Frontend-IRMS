...
interface FormEditincidentComponentProps {
...
const FormEditincidentComponent: React.FC<FormEditincidentComponentProps> = ({
  formData,
  handleChange,
  handleFileChange,
  handleSubmit,
...
export default FormEditincidentComponent;
