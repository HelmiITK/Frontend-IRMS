...
const HeaderEditIncidentComponent: React.FC = () => {
  return (
    <div className="flex flex-col gap-2 mb-2">
      ...
      <div className="flex items-center gap-1">
        ...
        <MdChevronRight className="text-gray-500" />
        <h1 className="text-sm capitalize text-black">edit incident report</h1>
      </div>
    </div>
  );
};

export default HeaderEditIncidentComponent;
